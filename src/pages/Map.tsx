...
const markers = [
  {
    id: 1,
    type: 'problem',
    title: 'Разбитая дорога на ул. Ключевая',
    description: 'Требуется ремонт дорожного покрытия',
    likes: 45,
    location: 'ул. Ключевая, 25',
  },
  {
    id: 2,
    type: 'idea',
  ...
  },
  {
    ...
    likes: 23,
    location: 'ул. Кости Рослого, 11',
  },
  {
    id: 4,
    type: 'idea',
    title: 'Велодорожка вдоль ул. Комсомольская',
    description: 'Идея создания велодорожки для безопасного передвижения по центру села',
    likes: 67,
    location: 'ул. Комсомольская',
  },
];
